...
import tictactoe.gameClient.appClasses.Game_Controller;
import tictactoe.gameClient.appClasses.Game_Model;
import tictactoe.gameClient.appClasses.Game_View;
import tictactoe.gameClient.splashScreen.Splash_Controller;
import tictactoe.gameClient.splashScreen.Splash_Model;
import tictactoe.gameClient.splashScreen.Splash_View;
 ...
 */
public class JavaFX_App_Driver extends Application {
	private static JavaFX_App_Driver mainProgram; // singleton
	...
	public void startApp() {
		...
		view = new Game_View(appStage, model);
		new Game_Controller(model, view);
	...
	protected static JavaFX_App_Driver getMainProgram() {
		return mainProgram;
	}
}
